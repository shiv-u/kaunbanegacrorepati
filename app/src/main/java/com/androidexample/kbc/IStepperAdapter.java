...
import moe.feng.common.stepperview.ViewBasedStepperAdapter;

/**
 * Base interface providing the adapter to populate steps inside of
 * a {@link moe.feng.common.stepperview.IStepperAdapter}. You have to implement this and create your
